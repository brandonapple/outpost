...
public class SteamManager : MonoBehaviour
{
	...
	protected virtual void Awake() {
		...
		try {
			...
			if (SteamAPI.RestartAppIfNecessary((AppId_t)2339690)) {
    ...
    public void ReachAchievement(AchievementType achType)
    {
        CompleteAchievement(achType.ToString());
    }
    ...
    public void RemoveAchievement(AchievementType achType)
    {
        ClearAchievement(achType.ToString());
    }
